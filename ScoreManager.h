...
namespace SCORING {
    constexpr int MAINTAIN_STEALTH = 10;    //add 10 points/s while staying entirely undetected
    constexpr int STAY_ALIVE = 5;           //add 5 points/s while staying alive
    constexpr int GET_SPOTTED = -50;        //remove 50 points whenever a guard is alerted
    constexpr int KILL = -150;              //remove 150 points whenever the player kills a guard
