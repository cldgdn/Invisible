...
namespace SCORING {
    ...
    constexpr int BOX_COLLECTED = 100;      //add 100 points for collecting the box
    ...
    constexpr float SCORE_DECAY = 5;        //% decay per second of maintain stealth and stay alive bonuses.
}
